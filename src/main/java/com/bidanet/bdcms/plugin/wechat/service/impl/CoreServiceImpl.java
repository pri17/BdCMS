...
import com.bidanet.bdcms.plugin.wechat.handler.LogHandler;
import com.bidanet.bdcms.plugin.wechat.handler.MsgHandler;
import com.bidanet.bdcms.plugin.wechat.handler.SubscribeHandler;
...
public class CoreServiceImpl implements CoreService {
    ...
    public WxMpUser getUserInfo(String openid, String lang) {
        ...
        try {
            wxMpUser = this.wxMpService.userInfo(openid, lang);
